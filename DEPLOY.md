...
| `AUTH_URL` | `https://your-app.up.railway.app` | 배포 후 도메인으로 변경 |
| `AUTH_KAKAO_ID` | 카카오 앱 키 | (선택) 카카오 로그인 |
| `AUTH_KAKAO_SECRET` | 카카오 시크릿 | (선택) 카카오 로그인 |
| `AUTH_NAVER_ID` | 네이버 앱 키 | (선택) 네이버 로그인 |
| `AUTH_NAVER_SECRET` | 네이버 시크릿 | (선택) 네이버 로그인 |
