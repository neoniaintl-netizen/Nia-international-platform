...
const MILESTONES = [
  ...
  { year: "2023", event: "NOVAREN 플랫폼 런칭" },
  ...
  return (
    <div className="max-w-[960px] mx-auto px-4 lg:px-6 py-8">
      ...
      <div className="bg-black text-white rounded-2xl p-8 md:p-12 mb-10">
        <p className="text-sm text-white/60 mb-2">About NOVAREN</p>
        ...
        <p className="text-sm text-white/70 max-w-lg leading-relaxed">
          노바렌(NOVAREN)는 한국 패션 브랜드의 중국 수출을 돕는 구매대행 플랫폼입니다.
      ...
      <section className="mb-10">
        ...
        <div className="bg-gray-50 rounded-xl p-8 text-center">
          ...
          <p className="text-sm text-gray-500 max-w-md mx-auto leading-relaxed">
            NOVAREN는 한국 패션 브랜드가 글로벌 시장에서 경쟁력을 갖출 수 있도록
