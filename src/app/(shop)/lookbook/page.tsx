  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 lg:px-6 py-6">
      <div className="flex items-center gap-1 text-xs text-gray-400 mb-4">
        ...
        <span className="text-black font-medium">룩북</span>
      </div>

      <div className="mb-8">
        <h1 className="text-2xl lg:text-3xl font-black mb-2">룩북</h1>
      ...
      <div className="flex items-center gap-2 mb-6 overflow-x-auto pb-1">
        {GENDER_TABS.map((t) => (
          <Link
            key={t.label}
            href={t.value ? `/lookbook?g=${t.value}` : "/lookbook"}
      ...
      {lookbooks.length === 0 ? (
        <div className="text-center py-20 text-gray-400">
          <p className="text-lg mb-2">룩북 준비중입니다</p>
          <p className="text-sm">곧 새로운 시즌 룩북을 만나보실 수 있습니다.</p>
        </div>
      ) : (
